<%-- 
    Document   : incluirDisciplina
    Created on : Feb 27, 2015, 9:38:33 PM
...
<script type="text/javascript">
    ...
    var tituloPagina = "Incluir Disciplina";
...
<div style='display: <%=display%>' id="divMensajeSucessos">
    <div class="alert alert-success" id="alertaMensajeSucesses">
        <strong>¡Felicidades!</strong> <s:message code="insercion.satisfactoria" arguments="disciplina"/> 
    </div>
</div>
<div style='display: <%=displayError%>' id="divMensajeError">
    <div class="alert alert-danger" id="alertaMensajeError">
        <strong>¡Opp!</strong> <s:message code="insercion.error" arguments="disciplina"/>
    </div>
</div>
...
<f:form role="form" method="post" commandName="disciplina">
