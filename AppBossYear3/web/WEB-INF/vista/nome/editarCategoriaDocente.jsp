<%-- 
    Document   : editarCategoriaDocente
    Created on : Feb 27, 2015, 5:13:51 PM
...
<script type="text/javascript">
    ...
    var tituloPagina = "Editar Categoria Docente";
...
<div style='display: <%=displayError%>' id="divMensajeError">
    <div class="alert alert-danger" id="alertaMensajeError">
        <strong>¡Opp!</strong> <s:message code="actualizacion.error" arguments="categoria docente"/>
    </div>
</div>

<div class="page-header">
    <h1>Editar Categoria Docente</h1>
</div>
