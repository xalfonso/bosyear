<%-- 
    Document   : incluirTipoActividad
    Created on : Feb 28, 2015, 11:39:04 AM
...
<script type="text/javascript">
    ...
    var tituloPagina = "Incluir Tipo de Actividad";
...
<div style='display: <%=display%>' id="divMensajeSucessos">
    <div class="alert alert-success" id="alertaMensajeSucesses">
        <strong>¡Felicidades!</strong> <s:message code="insercion.satisfactoria" arguments="tipo de actividad"/> 
    </div>
</div>
<div style='display: <%=displayError%>' id="divMensajeError">
    <div class="alert alert-danger" id="alertaMensajeError">
        <strong>¡Opp!</strong> <s:message code="insercion.error" arguments="tipo de actividad"/>
    </div>
</div>

<div class="page-header">
    <h1>Incluir Tipo de Actividad</h1>
</div>
