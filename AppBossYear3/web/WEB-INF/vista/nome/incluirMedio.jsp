<%-- 
    Document   : incluirMedio
    Created on : Feb 28, 2015, 12:20:18 PM
...
<script type="text/javascript">
    ...
    var tituloPagina = "Incluir Medio";
...
<div style='display: <%=display%>' id="divMensajeSucessos">
    <div class="alert alert-success" id="alertaMensajeSucesses">
        <strong>¡Felicidades!</strong> <s:message code="insercion.satisfactoria" arguments="medio"/> 
    </div>
</div>
<div style='display: <%=displayError%>' id="divMensajeError">
    <div class="alert alert-danger" id="alertaMensajeError">
        <strong>¡Opp!</strong> <s:message code="insercion.error" arguments="medio"/>
    </div>
</div>

<div class="page-header">
    <h1>Incluir Medio de Ense&ntilde;anza</h1>
</div>
